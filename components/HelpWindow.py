...
if __name__ == "__main__":
    ...
    def abrir_ajuda():
        # Exemplo de dicionário com opções
        opcoes = {
            "Cadastro de Clientes": {
                "texto": "Esta funcionalidade permite adicionar, editar e excluir clientes no sistema.\n\n" +
                        "Para adicionar um novo cliente, clique no botão 'Novo' e preencha todos os campos obrigatórios.",
                "imagem": None  # Caminho para uma imagem, se disponível
            },
            "Relatórios": {
                "texto": "Gere relatórios detalhados de vendas, estoque e clientes.",
                "tags": {
                    "Gere relatórios detalhados de ": "",
                    "vendas": "bold",
                    ", ": "",
                    "estoque": "bold",
                    " e ": "",
                    "clientes": "bold",
                    ".\n\nSelecione o tipo de relatório e defina o período desejado.": ""
                },
                "imagem": None
            }
        }
        ...
        help_window.add_options(opcoes)
    
    ttk.Button(root, text="Abrir Ajuda", command=abrir_ajuda).pack(expand=True)
